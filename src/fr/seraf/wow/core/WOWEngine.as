...
package fr.seraf.wow.core {
	...
	public class WOWEngine {
		...
		private function isCustomParticle(p:WParticle):Boolean {
			...
			var isSP:Boolean = (className == "fr.seraf.wow.primitive::WSphere");
			var isPP:Boolean = (className ==  "fr.seraf.wow.primitive::WOWPlane");
			var isAP:Boolean = (className == "fr.seraf.wow.primitive::WAdvSphere");
